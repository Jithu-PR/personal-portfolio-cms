...
export interface ApiProfileProfile extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    socialLinks: Schema.Attribute.Component<'shared.links', true> &
      Schema.Attribute.Required;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateCompleted: Schema.Attribute.Date & Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    repositoryLink: Schema.Attribute.String & Schema.Attribute.Required;
    technologiesUsed: Schema.Attribute.Relation<
      'manyToMany',
      'api::skill.skill'
    >;
